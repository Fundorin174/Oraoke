...
let initialState = {
  songs: [
    {
      ...
      itemsOnCanvasCoordinates: [
        {type: 'trapeze', x1: 400, y1: 'h0', x2: 100, x3: 0, x4: 1000, y2: 'h1'},//Ночь по улицам пошла
        {type: 'trapeze', x1: 1250, y1: 'h6', x2: 100, x3: 100, x4: 1500, y2: 'h3'},
        {type: 'trapeze', x1: 1680, y1: 'h0', x2: 100, x3: 100, x4: 2000, y2: 'h2'},//Звездной постутью
        {type: 'triangle', x1: 2150, y1: 'h0', x2: 2225, y2:'h3', x3: 2300},// цариц
        {type: 'trapeze', x1:2550 , y1: 'h6', x2:100 , x3:100 , x4:3000 , y2: 'h4'},
        {type: 'trapeze', x1:3100 , y1: 'h0', x2:100 , x3:100 , x4:3670 , y2: 'h2'},////Слов и чисел простота
        {type: 'trapeze', x1: 3830, y1: 'h0', x2:100 , x3:100 , x4:4300 , y2: 'h2'},//у небесного моста
        {type: 'trapeze', x1: 3830, y1: 'h6', x2:100 , x3:100 , x4:4300 , y2: 'h5'},
        {type: 'trapeze', x1:4570 , y1: 'h0', x2:50 , x3:50 , x4:4980 , y2: 'h2'},//раскидала перья
        {type: 'triangle', x1:5000, y1: 'h0', x2:5175, y2:'h4', x3:5350},//пти и и и и и ц
        {type: 'trapeze', x1:5500 , y1: 'h6', x2:100 , x3:100 , x4:6360 , y2: 'h5'},
        {type: 'trapeze', x1:5870 , y1: 'h0', x2:100 , x3:100 , x4: 6360, y2: 'h1'},//Не забудутся никем
        {type: 'trapeze', x1:6560 , y1: 'h6', x2:100 , x3:100 , x4: 6800, y2: 'h3'},
        {type: 'trapeze', x1:7150 , y1: 'h0', x2:100 , x3:100 , x4:7800 , y2: 'h2'},//праздник губ обид и глаз
        {type: 'trapeze', x1:7950 , y1: 'h6', x2:100 , x3:100 , x4:8200 , y2: 'h4'},
        {type: 'trapeze', x1: 8580, y1: 'h0', x2:100 , x3:100 , x4:9200 , y2: 'h3'},//Забери меня в свой плен
        {type: 'trapeze', x1:9400 , y1: 'h0', x2:100 , x3:100 , x4:9800 , y2: 'h2'},//эту линию колен
        {type: 'trapeze', x1:10050 , y1: 'h0', x2:50 , x3:50 , x4:10550 , y2: 'h3'},//целовать в последний
        {type: 'triangle', x1:10650, y1: 'h0', x2:10775, y2:'h4', x3:10900},//раааааааз
        {type: 'trapeze', x1:11200 , y1: 'h0', x2:100 , x3:100 , x4:11670 , y2: 'h3'},//Тоооолькооооооо
        {type: 'trapeze', x1:11930 , y1: 'h0', x2:100 , x3:100 , x4:12566 , y2: 'h3'},//рюмка водкииии на столе
        {type: 'trapeze', x1:12770 , y1: 'h0', x2:100 , x3:100 , x4:13390 , y2: 'h2'},//Ветер плачет за окнооом
        {type: 'trapeze', x1:13550 , y1: 'h0', x2:100 , x3:100 , x4:13780 , y2: 'h3'},//тиииииихооо
        {type: 'trapeze', x1:13900 , y1: 'h0', x2:100 , x3:100 , x4:14200 , y2: 'h3'},//больююююю
        {type: 'trapeze', x1:14400 , y1: 'h6', x2:100 , x3:100 , x4:14700 , y2: 'h4'},
        {type: 'trapeze', x1:14736 , y1: 'h0', x2:100 , x3:100 , x4:15400 , y2: 'h2'},//о т з ы в а ю т с я в о м н е
        {type: 'trapeze', x1:15550 , y1: 'h0', x2:100 , x3:100 , x4:16050 , y2: 'h2'},// э т о й молодой   л у н ы
        {type: 'trapeze', x1:15700 , y1: 'h6', x2:100 , x3:100 , x4:15900 , y2: 'h5'},
        {type: 'trapeze', x1:16280 , y1: 'h0', x2:100 , x3:100 , x4:16490 , y2: 'h3'},//к р и к и
        ],
      isPlaying: false,
      songText:
    ...
    {
      songID: "1",
      songName: {ru: "Экспонат (Лабутены)", en: 'Eksponat (Labuteny)'},
      artistName: {ru: "Ленинград", en: 'Leningrad'},
      fullTitle: {ru: "Ленинград - Экспонат (Лабутены)", en: 'Leningrad - Eksponat (Labuteny)'},
    ...
    {
      songID: "2",
      songName: {ru: "Улыбайся", en: 'Ulibaisya'},
      artistName: {ru: "AIOWA", en: 'AIOWA'},
      fullTitle: {ru: "Aiowa - Улыбайся", en: 'Aiowa - Ulibaisya'},
    ...
    {
      songID: "3",
      songName: {ru: "Зацепила", en: 'Zazepila'},
      artistName: {ru:"Артур Пирожков", en:'Artur Pirozhkov' },
      fullTitle: {ru:"Артур Пирожков - Зацепила", en: 'Artur Pirozhkov - Zazepila'},
    ...
    {
      songID: "4",
      songName: {ru:"Моя бабушка курит трубку", en: 'Moya babushka kurit trubku'},
      artistName: {ru:"Гарик Сукачев", en: 'Garik Sukochev'},
      fullTitle: {ru:"Гарик Сукачев - Моя бабушка курит трубку", en: 'Garik Sukochev - Moya babushka kurit trubku'},
    ...
    {
      songID: "5",
      songName: {ru:"О Боже! Какой мужчина!", en: "O Bozhe! Kakoy muzhchina!"},
      artistName: {ru:"Натали", en: 'Nataly'},
      fullTitle: {ru:"Натали - О Боже! Какой мужчина!", en: 'Nataly - O Bozhe! Kakoy muzhchina!'},
  ...
  currentSong: {
    ...
    itemsOnCanvasCoordinates: [
      {type: 'trapeze', x1: 400, y1: 'h0', x2: 100, x3: 0, x4: 950, y2: 'h1'},//Ночь по улицам пошла
      {type: 'trapeze', x1: 1250, y1: 'h6', x2: 100, x3: 100, x4: 1500, y2: 'h3'},
      {type: 'trapeze', x1: 1680, y1: 'h0', x2: 100, x3: 100, x4: 2000, y2: 'h2'},//Звездной постутью
      {type: 'triangle', x1: 2150, y1: 'h0', x2: 2225, y2:'h3', x3: 2300},// цариц
      {type: 'trapeze', x1:2500 , y1: 'h6', x2:100 , x3:50 , x4:2900 , y2: 'h4'},
      {type: 'trapeze', x1:3050 , y1: 'h0', x2:100 , x3:100 , x4:3620 , y2: 'h2'},////Слов и чисел простота
      {type: 'trapeze', x1: 3800, y1: 'h0', x2:100 , x3:100 , x4:4250 , y2: 'h2'},//у небесного моста
      {type: 'trapeze', x1: 3800, y1: 'h6', x2:100 , x3:100 , x4:4250 , y4: 'h5'},
      {type: 'trapeze', x1:4470 , y1: 'h0', x2:50 , x3:50 , x4:4880 , y2: 'h2'},//раскидала перья
      {type: 'triangle', x1:5000, y1: 'h0', x2:5125, y2:'h3', x3:5250},//пти и и и и и ц
      {type: 'trapeze', x1:5500 , y1: 'h6', x2:100 , x3:100 , x4:6360 , y2: 'h5'},
      {type: 'trapeze', x1:5750 , y1: 'h0', x2:100 , x3:100 , x4: 6240, y2: 'h1'},//Не забудутся никем
      {type: 'trapeze', x1:6560 , y1: 'h6', x2:100 , x3:100 , x4: 6800, y2: 'h3'},
      {type: 'trapeze', x1:7050 , y1: 'h0', x2:100 , x3:100 , x4:7650 , y2: 'h2'},//праздник губ обид и глаз
      {type: 'trapeze', x1:7850 , y1: 'h6', x2:100 , x3:100 , x4:8200 , y2: 'h4'},
      {type: 'trapeze', x1: 8430, y1: 'h0', x2:100 , x3:100 , x4:9100 , y2: 'h3'},//Забери меня в свой плен
      {type: 'trapeze', x1:9230 , y1: 'h0', x2:100 , x3:100 , x4:9630 , y2: 'h2'},//эту линию колен
      {type: 'trapeze', x1:9850 , y1: 'h0', x2:100 , x3:50 , x4:10200 , y2: 'h2'},//целовать в последний
      {type: 'triangle', x1:10400, y1: 'h0', x2:10525, y2:'h4', x3:10650},//раааааааз
      {type: 'trapeze', x1:10900 , y1: 'h0', x2:100 , x3:100 , x4:11370 , y2: 'h3'},//Тоооолькооооооо
      {type: 'trapeze', x1:11630 , y1: 'h0', x2:100 , x3:100 , x4:12266 , y2: 'h3'},//рюмка водкииии на столе
      {type: 'trapeze', x1:12570 , y1: 'h0', x2:100 , x3:100 , x4:12990 , y2: 'h2'},//Ветер плачет за окнооом
      {type: 'trapeze', x1:13200 , y1: 'h0', x2:100 , x3:100 , x4:13400 , y2: 'h3'},//тиииииихооо
      {type: 'trapeze', x1:13550 , y1: 'h0', x2:100 , x3:100 , x4:13850 , y2: 'h3'},//больююююю
      {type: 'trapeze', x1:14000 , y1: 'h6', x2:100 , x3:100 , x4:14300 , y2: 'h4'},
      {type: 'trapeze', x1:14386 , y1: 'h0', x2:100 , x3:100 , x4:15000 , y2: 'h2'},//о т з ы в а ю т с я в о м н е
      {type: 'trapeze', x1:15180 , y1: 'h0', x2:100 , x3:100 , x4:15650 , y2: 'h2'},// э т о й молодой   л у н ы
      {type: 'trapeze', x1:15200 , y1: 'h6', x2:100 , x3:100 , x4:15500 , y2: 'h5'},
      {type: 'trapeze', x1:15880 , y1: 'h0', x2:100 , x3:100 , x4:16090 , y2: 'h3'},//к р и к и
